...
// should be       'https://raw.githubusercontent.com/ethereum/mist/master/clientBinaries.json' //changed for lancium
const BINARY_URL = 'https://raw.githubusercontent.com/yashpl/mist/develop/clientBinaries.json';

const ALLOWED_DOWNLOAD_URLS_REGEX =
    /^https:\/\/(?:(?:[A-Za-z0-9](?:[A-Za-z0-9-]{0,61}[A-Za-z0-9])?\.)?github\.com\/|github.com\/yashpl\/go-ethereum\/tree\/master\/downloads\/|bintray\.com\/artifact\/download\/karalabe\/ethereum\/)(?:.+)/;  // eslint-disable-line max-len
